...
const services = [
  {
    ...
    description:
      "Armações das melhores marcas internacionais com lentes de alta tecnologia.",
    icon: (
  ...
  },
  {
    title: "Óculos de Sol",
    description:
      "Proteção UV com estilo. As tendências das principais maisons internacionais.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    title: "Lentes",
    description:
      "Lentes de contato e lentes oftálmicas com as melhores tecnologias do mercado.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      "Serviço especializado de manutenção e ajuste para seus óculos.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12 md:mb-16">
          ...
          <h2 className="reveal font-display font-bold text-display-md text-white max-w-2xl">
            Tudo para sua <span className="text-brand-400">visão</span>
          </h2>
        </div>
